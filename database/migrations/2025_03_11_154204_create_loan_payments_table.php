...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('loan_payments', function (Blueprint $table) {
            ...
            $table->string('loan_card_last_digits', 4)->nullable(); // Solo si se usa Tarjeta como loan_quote_payment_mode
            $table->string('loan_card_auth_number', 12)->nullable(); // Solo si se usa Tarjeta como loan_quote_payment_mode
            $table->decimal('loan_quote_payment_received', 10, 2);
            $table->decimal('loan_quote_payment_change', 10, 2);
            $table->string('loan_bank_operation_number', 12)->nullable(); // Solo si se usa Deposito como sale_payment_type
            $table->string('loan_bankcheck_info', 40)->nullable(); // Solo si se usa Cheque como sale_payment_type
            $table->timestamps();
        });
    }
