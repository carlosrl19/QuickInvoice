...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|min:3|max:55|regex:/^[^\d]+$/|unique:users',
            'user_phone' => 'required|string|min:8|max:8|unique:users',
            'user_dni' => 'required|string|min:13|max:13|unique:users',
            'user_address' => 'required|string|min:3|max:155',
