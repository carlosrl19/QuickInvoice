...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'seller_name' => 'required|string|min:3|max:55|regex:/^[^\d]+$/|unique:sellers,seller_name,' . $sellerId . '',
            'seller_document' => 'required|string|min:13|max:14|regex:/^[0-9]+$/|unique:sellers,seller_document,' . $sellerId . '',
            'seller_phone' => 'required|string|min:8|max:8|regex:/^[0-9]+$/|unique:sellers,seller_phone,' . $sellerId . '',
        ];
    }
