                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="#">Rechazar solicitud</a>
                                        <div role="separator" class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">Eliminar solicitud</a>
                                    </div>
                                </td>
                            </tr>

                            <!-- Include -->
                            @include('modules.loans_request._sweet_alerts')
...
@include('modules.loans_request._create')
@endsection
