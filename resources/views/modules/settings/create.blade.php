        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('settings.store')}}" enctype="multipart/form-data" novalidate spellcheck="false">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <img class="mb-3" style="display: grid; margin: auto" id="logoPreview" width="200" height="200">
                        ...
                        <div class="col">
                            <img class="mb-3" style="display: grid; margin: auto" id="systemIconPreview" width="200" height="200">
                            <div class="form-floating">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" maxlength="14" name="company_rtn" value="{{ old('company_rtn') }}"
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" maxlength="8" name="company_phone" value="{{ old('company_phone') }}"
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-floating">
                                <textarea
                                    class="form-control @error('company_address') is-invalid @enderror" autocomplete="off" maxlength="75"
                                    name="company_address" rows="6" id="company_address" style="resize: none;">{{ old('company_address') }}</textarea>
                                @error('company_address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                @enderror
                                <label for="company_address">Domicilio</label>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <select class="form-select @error('show_system_name') is-invalid @enderror" name="show_system_name">
                                ...
                                <option value="1" {{ old('show_system_name') == '1' ? 'selected' : '' }}>MOSTRAR NOMBRE DEL SISTEMA</option>
                                <option value="0" {{ old('show_system_name') == '0' ? 'selected' : '' }}>OCULTAR NOMBRE DEL SISTEMA</option>
                            </select>
