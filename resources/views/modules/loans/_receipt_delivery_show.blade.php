...
<ul class="breadcrumbs mb-1 op-4">
    ...
    <li class="nav-item fw-bold">
        <a href="#">Comprobante de entrega</a>
    </li>
</ul>
@endsection
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <p class="text-center mb-0 d-none d-xl-inline d-lg-inline d-md-inline">
                        Comprobante de entrega / <span class="text-muted">#{{ $loan->loan_request_number }}</span>
                    </p>
                </div>
                <iframe frameborder="0" class="iframe-doc" style="width: 100%;" src="{{ route('loans.loan_receipt_delivery_report', $loan->id) }}"></iframe>
            </div>
        </div>
    </div>
</div>
