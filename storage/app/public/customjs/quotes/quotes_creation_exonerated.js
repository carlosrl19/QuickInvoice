...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateTotal() {
        ...
        // Como el impuesto es 0, el subtotal sin impuesto es igual al total
        const subtotalWithoutTax = total;
        const taxAmount = 0; // Impuesto es 0
        ...
        document.getElementById('total_amount').innerText = `L. ${formatNumber(total)}`;
        quoteTotalAmountInput.value = total.toFixed(2);
