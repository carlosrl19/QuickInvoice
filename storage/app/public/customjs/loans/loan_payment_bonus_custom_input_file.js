function carouselLoanPaymentsBonusViewer(event, loanId) {
    const files = event.target.files;
    const previewContainer = document.getElementById('image-preview-bonus-container');
    ...
    for (let i = 0; i < files.length; i++) {
        ...
        reader.onload = function (e) {
            ...
            imgContainer.classList.add('image-preview-bonus');
