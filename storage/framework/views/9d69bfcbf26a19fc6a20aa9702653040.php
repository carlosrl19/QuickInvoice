...
<?php endif; ?>
                                ...
                                <td>
                                    <span class="badge <?php if($product->product_barcode != ''): ?> bg-secondary2 text-secondary <?php else: ?> bg-warning text-white <?php endif; ?>"><?php echo e($product->product_barcode ? $product->product_barcode:'SIN CODIGO'); ?></span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo e($currency); ?> <?php echo e(number_format($product->product_buy_price,2)); ?>

                                </td>
                                <td>
                                    <?php echo e($currency); ?> <?php echo e(number_format($product->product_sell_price,2)); ?>
