                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col text-center">
                            <img class="border rounded-circle p-1" src="<?php echo e(Storage::url('uploads/products/' . $product->product_image )); ?>" onerror="this.onerror=null;this.src='<?php echo e(Storage::url('sys_config/img/image_loading_failed.png')); ?>'" width="150" height="150">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/carlos/Code/Code/QuickInvoice/resources/views/modules/products/edit.blade.php ENDPATH**/ ?>