  ...
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    <div class="row mt-4 text-center">
      ...
      <div style="width: 450px;">
        <img src="<?php echo e(asset('static/errors/403.png')); ?>" alt="">
      </div>
      <p class="text-muted">
        "Solicita acceso al administrador del sistema, de lo contrario no podrás ingresar.<br>
        Se notificó al administrador sobre este intento no permitido."
      </p>
      <p>
...
</html><?php /**PATH /home/carlos/Code/Code/QuickInvoice/resources/views/errors/403.blade.php ENDPATH**/ ?>